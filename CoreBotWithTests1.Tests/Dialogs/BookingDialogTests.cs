...
using CoreBotWithTests1.Tests.Common;
using CoreBotWithTests1.Tests.Dialogs.TestData;
...
using CoreBotWithTests1;
using CoreBotWithTests1.Dialogs;

namespace CoreBotWithTests1.Tests.Dialogs
{
